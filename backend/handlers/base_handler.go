...
func RegisterRoutes(r *gin.RouterGroup) {
	...
	tripsGroup.GET("/favorites/list", GetFavoriteTripHandler)
	tripsGroup.POST("/favorites/:id", AddFavoriteTripHandler)
	tripsGroup.DELETE("/favorites/:id", RemoveFavoriteTripHandler)
